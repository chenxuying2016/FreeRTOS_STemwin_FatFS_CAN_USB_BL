...
/* 按键口对应的RCC时钟 */
#define RCC_ALL_KEY 	(RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOB |RCC_AHB1Periph_GPIOD | RCC_AHB1Periph_GPIOG)
...
#define GPIO_PORT_K8    GPIOD
#define GPIO_PIN_K8	    GPIO_Pin_3

#define GPIO_PORT_K9    GPIOD
#define GPIO_PIN_K9	    GPIO_Pin_4
...
*/
	...
	static uint8_t IsKeyDown8(void) {if ((GPIO_PORT_K8->IDR & GPIO_PIN_K8) != 0) return 1;else return 0;}
#endif
	static uint8_t IsKeyDown9(void) {if (IsKeyDown7() && IsKeyDown8()) return 1;else return 0;}

//uint8_t last_status,current_status,flag,count;	
//	static uint8_t IsKeyLeftRight(void) 
//	{
//		if(IsKeyDown3)
//			last_status = 1;
//		else
...
//		}
//	}
//	static uint8_t IsKeyDown9(void) {if (IsKeyLeftRight) return 1;else return 0;}
//	static uint8_t IsKeyDown10(void) {if (!IsKeyLeftRight) return 1;else return 0;}
...
static void bsp_InitKeyHard(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_PIN_K9;
	GPIO_Init(GPIO_PORT_K9, &GPIO_InitStructure);
}
...
//	s_tBtn[KID_JOY_U].LongTime = 20;
//	s_tBtn[KID_JOY_U].RepeatSpeed = 20;	/* 每隔50ms自动发送键值 */

//	s_tBtn[KID_JOY_D].LongTime = 20;
//	s_tBtn[KID_JOY_D].RepeatSpeed = 20;	/* 每隔50ms自动发送键值 */
