...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {	
  ...
  { TEXT_CreateIndirect, "Text", ID_TEXT_5, 480, 230, 170, 28, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "Text", ID_TEXT_6, 480, 265, 170, 28, 0, 0x64, 0 },
  ...
  { TEXT_CreateIndirect, "Text", ID_TEXT_10, 650, 125, 100, 28, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "Text", ID_TEXT_11, 650, 160, 100, 28, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "Text", ID_TEXT_12, 650, 195, 100, 28, 0, 0x64, 0 },
  { EDIT_CreateIndirect, "Edit", ID_EDIT_0, 650, 234, 60, 20, 0, 0x64, 0 },
  { EDIT_CreateIndirect, "Edit", ID_EDIT_1, 650, 269, 60, 20, 0, 0x64, 0 },
  { EDIT_CreateIndirect, "Edit", ID_EDIT_2, 650, 304, 60, 20, 0, 0x64, 0 },

  { TEXT_CreateIndirect, "Text", ID_TEXT_13, 720, 230, 40, 28, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "Text", ID_TEXT_14, 720, 265, 40, 28, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "Text", ID_TEXT_15, 720, 300, 40, 28, 0, 0x64, 0 },
  { DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_1, 650, 335, 100, 20, 0, 0x0, 0 },
  { DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_2, 650, 370, 100, 20, 0, 0x0, 0 },
  ...
  { EDIT_CreateIndirect, "Edit", ID_EDIT_15, 650, 405, 60, 20, 0, 0x64, 0 },
...
//		InitDialog(pMsg);
	{
		...
		//
		hItem = pMsg->hWin;
		WINDOW_SetBkColor(hItem, 0x00D8E9EC);//0x00D8E9EC);		0x00535353
		//
		// Initialization of 'Text'
		//
...
//		picture_num=0;
		...
		TEXT_SetFont(hItem, &GUI_Fontkai24);
		TEXT_SetTextAlign(hItem, GUI_TA_LEFT | GUI_TA_VCENTER);
		TEXT_SetText(hItem, "设置背光电压:");
		hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_6);
		TEXT_SetTextAlign(hItem, GUI_TA_LEFT | GUI_TA_VCENTER);
		TEXT_SetFont(hItem, &GUI_Fontkai24);
		TEXT_SetText(hItem, "设置背光电流:");
		hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_7);
		TEXT_SetTextAlign(hItem, GUI_TA_LEFT | GUI_TA_VCENTER);
		TEXT_SetFont(hItem, &GUI_Fontkai24);
		TEXT_SetText(hItem, "设置总时间:");
